        ...
        <div className="container">
            ...
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
              <div className="mb-12 max-w-[360px] lg:mb-16">
                ...
                <p className="mb-9 text-base leading-relaxed text-body-color dark:text-body-color-dark text-justify">
                  Specialized in React, Next.js, Node.js, and Web3 technologies. I craft production-grade applications with thoughtful design and robust architecture.
                </p>
                <div className="flex items-center">
                  {/* Email */}
                  <a
                    href="mailto:shyamsprasathssp@gmail.com"
                    aria-label="Email"
                    className="mr-6 text-body-color transition duration-300 hover:text-primary dark:text-body-color-dark dark:hover:text-primary"
                  >
                  ...
                  {/* LinkedIn */}
                  <a
                    href="https://www.linkedin.com/in/s-shyam-prasath/"
                    target="_blank"
                  ...
                  {/* GitHub */}
                  <a
                    href="https://github.com/Shyam-Prasath"
                    target="_blank"
                    rel="noopener noreferrer"
                    aria-label="GitHub"
                    className="mr-6 text-body-color transition duration-300 hover:text-primary dark:text-body-color-dark dark:hover:text-primary"
                ...
                <ul>
                  <li>
                    <a
                      ...
                      className="mb-4 inline-block text-base text-body-color duration-300 hover:text-primary dark:text-body-color-dark dark:hover:text-primary"
                    >
                      Founder Fourm (Start Up Pitching)
                    </a>
                  </li>
                  <li>
                    <a
          ...
          <div className="py-8">
            <p className="text-center text-base text-body-color dark:text-white">
              ...
              >
              Built with React, Next.js, and creative engineering.
              </a>
            </p>
          </div>
        </div>
