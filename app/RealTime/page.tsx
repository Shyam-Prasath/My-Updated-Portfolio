...
export const metadata: Metadata = {
    title: "Real-Time Chat Application | Shyam Prasath",
};
        ...
        <div className="container">
            ...
            <div className="w-full px-4 lg:w-8/12">
                ...
                <h1 className="mb-8 text-3xl font-bold leading-tight text-black dark:text-white sm:text-4xl">
                    Chat-World — Real-Time Chat & Web3 Communication Platform
                </h1>
                <div className="mb-10 flex flex-wrap items-center justify-between border-b border-body-color border-opacity-10 pb-4 dark:border-white/10">
                    ...
                    <p className="mb-5 flex items-center text-base font-medium text-body-color">
                        Sep 2023 • Real-Time Web Application
                    </p>
                    </div>
                ...
                <p className="mb-10 text-lg leading-relaxed text-body-color">
                    Chat-World is a full-stack real-time messaging application
                    designed for secure, fast, and modern communication. It supports
                    1-to-1 and group chats, file sharing, video calls via WebRTC, and
                ...
                <div className="mb-10 overflow-hidden rounded">
                    ...
                    <Image
                        src={getImagePath("/images/tracebloom/Realchat.png")}
                ...
                <p className="mb-8 text-lg leading-relaxed text-body-color">
                    The application leverages Socket.IO for real-time messaging and
                    signaling, JWT for secure session management, and optional Web3
                    authentication for passwordless login. Users can exchange
                    messages, share files, preview conversations, and initiate video
                    calls seamlessly.
                </p>
                ...
                <ul className="mb-10 list-disc list-inside text-body-color text-lg">
                    <li>JWT & MetaMask wallet authentication</li>
                    <li>1-to-1 and group chat support</li>
                    <li>Real-time messaging with Socket.IO</li>
                    <li>File uploads and media sharing</li>
                    <li>Last message preview in chat list</li>
                    <li>WebRTC-based video calling</li>
                    <li>Light & dark theme support</li>
                    <li>Fully responsive UI</li>
                </ul>
                <div className="relative z-10 mb-10 overflow-hidden rounded-md bg-primary bg-opacity-10 p-8 md:p-9 lg:p-8 xl:p-9">
                        <p className="text-center text-base font-medium italic text-body-color">
                        “Chat-World combines real-time communication with Web3
                        authentication, offering a modern, secure, and scalable chat
                        experience.”
                        </p>
                ...
                <div className="flex flex-wrap items-center justify-between">
                    ...
                    <div className="flex sm:justify-end">
                        <ShareProject
                            githubUrl="https://github.com/Shyam-Prasath/Chat-World-Frontend"
                            liveUrl="https://chat-world-sbr.vercel.app/"
                        />
                    </div>
                    </div>
                </div>
            ...
            <aside className="w-full px-4 lg:w-4/12">
                ...
                <div className="flex flex-wrap px-8 py-6">
                    <TagButton text="Socket.IO" />
                    <TagButton text="WebRTC" />
                    <TagButton text="MetaMask Auth" />
                    <TagButton text="JWT" />
                    <TagButton text="File Uploads" />
                    <TagButton text="Real-Time Chat" />
                </div>
                </div>
            </aside>
            </div>
