...
export const metadata: Metadata = {
  title: "TraceBloom | Shyam Prasath",
};

const TraceBloomPage = () => {
  return (
          ...
          <div className="w-full px-4 lg:w-8/12">
            <article>
              <h1 className="mb-8 text-3xl font-bold leading-tight text-black dark:text-white sm:text-4xl">
                TraceBloom – Blockchain-Powered Agricultural Supply Chain Platform
              </h1>
              <div className="mb-10 flex flex-wrap items-center justify-between border-b border-body-color border-opacity-10 pb-4 dark:border-white/10">
                <div className="flex flex-wrap items-center">
                  ...
                  <p className="mb-5 flex items-center text-base font-medium text-body-color">
                    Oct 2025 • Blockchain Case Study • Web3 Full Stack Project
                  </p>
                </div>
              ...
              <p className="mb-10 text-lg leading-relaxed text-body-color">
                TraceBloom is a full-stack Web3 platform that enables transparent,
                trustless, and verifiable agricultural supply chains. It connects
                farmers, distributors, and consumers using blockchain tracking,
                smart contract escrow payments, and real-time verification.
              </p>

              <div className="mb-10 overflow-hidden rounded">
                <div className="relative aspect-[97/44] w-full">
                  <Image
                    src={getImagePath("/images/tracebloom/Thumbnail.png")}
                    alt="TraceBloom dashboard"
                    fill
              ...
              <p className="mb-8 text-lg leading-relaxed text-body-color">
                The platform ensures end-to-end agricultural batch tracking,
                blockchain-verified supply chain history, and secure escrow-based
                payments. Every transaction and batch update is immutably stored
                on-chain, eliminating intermediaries and fraud.
              </p>
              ...
              <ul className="mb-10 list-disc list-inside text-body-color text-lg">
                <li>End-to-end agricultural batch tracking</li>
                <li>Blockchain-verified supply chain transparency</li>
                <li>Smart contract escrow-based payments</li>
                <li>Wallet authentication with role-based access</li>
              </ul>

              <div className="relative z-10 mb-10 overflow-hidden rounded-md bg-primary bg-opacity-10 p-8 md:p-9 lg:p-8 xl:p-9">
                    <p className="text-center text-base font-medium italic text-body-color">
                      “TraceBloom enables farmers to receive secure, direct blockchain
                  payments while giving consumers full transparency into the
                  product lifecycle — from farm to table.”
                    </p>
              ...
              <div className="flex flex-wrap items-center justify-between">
                <div className="mb-5">
                  ...
                  <div className="flex flex-wrap">
                    <TagButton text="React + TypeScript" />
                    <TagButton text="Node.js & Prisma" />
                    <TagButton text="Solidity & Ethers.js" />
                ...
                <div className="mb-5">
                  ...
                  <div className="flex sm:justify-end">
                    <ShareProject
                        githubUrl="https://github.com/Shyam-Prasath/TraceBloom-Frontend"
                        liveUrl="https://trace-bloom-frontend.vercel.app/"
                    />
                  </div>
                </div>
              </div>
          ...
          <aside className="w-full px-4 lg:w-4/12">
            ...
            <div className="rounded-sm bg-white shadow-three dark:bg-gray-dark">
              ...
              <div className="flex flex-wrap px-8 py-6">
                ...
                <TagButton text="Smart Contracts" />
                <TagButton text="Supply Chain" />
              </div>
            </div>
          </aside>
        </div>
