...
export const metadata: Metadata = {
    title: "Web 3 Deployer | Shyam Prasath",
};

const Web3DeployerPage = () => {
    return (
        ...
        <div className="container">
            ...
            <div className="w-full px-4 lg:w-8/12">
                ...
                <h1 className="mb-8 text-3xl font-bold leading-tight text-black dark:text-white sm:text-4xl">
                    Web3 Deployer – Decentralized Website & dApp Hosting Platform
                </h1>
                ...
                Web3 Deployer is a fully decentralized hosting platform that
                enables developers to deploy static websites and dApps directly
                to the blockchain. It ensures censorship resistance, verifiable
                deployments, and permanent hosting using IPFS, Pinata,
                Web3Storage, and smart contracts.
                </p>

                <div className="mb-10 overflow-hidden rounded">
                    <div className="relative aspect-[97/44] w-full">
                    <Image
                        src={getImagePath("/images/tracebloom/Web3deployer.png")}
                        alt="Web3 Deployer dashboard"
                        fill
                ...
                The platform integrates decentralized storage, blockchain-based
                verification, secure authentication, and AI-powered assistance
                to deliver a seamless developer experience. Every deployment is
                recorded on-chain, ensuring transparency, trust, and
                immutability.
                </p>
                ...
                <ul className="mb-10 list-disc list-inside text-body-color text-lg">
                    <li>Decentralized hosting using IPFS & Pinata</li>
                    <li>Persistent storage via Web3Storage (Filecoin-backed)</li>
                    <li>Smart contracts for immutable deployment records</li>
                    <li>Web3Auth authentication with wallets or social login</li>
                    <li>AI-powered assistance using Google Gemini</li>
                    <li>Real-time analytics and deployment monitoring</li>
                </ul>

                <div className="relative z-10 mb-10 overflow-hidden rounded-md bg-primary bg-opacity-10 p-8 md:p-9 lg:p-8 xl:p-9">
                        <p className="text-center text-base font-medium italic text-body-color">
                        “Web3 Deployer removes intermediaries from web hosting,
                        empowering developers with censorship-resistant,
                ...
                <div className="flex flex-wrap items-center justify-between">
                    <div className="mb-5">
                        ...
                        <div className="flex flex-wrap">
                            ...
                            <TagButton text="IPFS" />
                            <TagButton text="Solidity" />
                            <TagButton text="Web3Auth" />
                            <TagButton text="Google Gemini" />
                        </div>
                    </div>
                    ...
                    <div className="flex sm:justify-end">
                        <ShareProject
                            githubUrl="https://github.com/Shyam-Prasath/web-3-deployer"
                            liveUrl="https://web-3-deployer.vercel.app/"
                        />
                    </div>
                    </div>
                </div>
            ...
            <aside className="w-full px-4 lg:w-4/12">
                ...
                <div className="mb-10 rounded-sm bg-white shadow-three dark:bg-gray-dark dark:shadow-none">
                    ...
                    <li>
                        ...
                        className="mb-3 inline-block text-base font-medium text-body-color hover:text-primary"
                        >
                        Blockchain Deployment Platforms
                        </a>
                    </li>
                    <li>
                        <a
                ...
                <div className="flex flex-wrap px-8 py-6">
                    <TagButton text="IPFS" />
                    <TagButton text="Pinata" />
                    <TagButton text="Web3Storage" />
                    <TagButton text="Solidity" />
                    <TagButton text="Ethereum / Polygon" />
                    <TagButton text="Web3Auth" />
                    <TagButton text="Google Gemini AI" />
                    <TagButton text="Decentralized Hosting" />
                </div>
                </div>
            </aside>
            </div>
...
export default Web3DeployerPage;