        ...
        <div className="container">
            ...
            <div className="w-full px-4 lg:w-8/12">
                ...
                <h1 className="mb-8 text-3xl font-bold leading-tight text-black dark:text-white sm:text-4xl">
                    MediBook — Online Doctor Appointment & Consultation System
                </h1>
                ...
                MediBook is a full-stack medical appointment scheduling and
                consultation system that connects patients, doctors, and
                administrators through a real-time, intelligent booking
                platform. It streamlines availability management, appointment
                workflows, and secure video consultations using modern web
                technologies and AI-assisted logic.
                </p>
                <div className="mb-10 overflow-hidden rounded">
                    <div className="relative aspect-[97/44] w-full">
                    <Image
                        src={getImagePath("/images/tracebloom/Medibook.png")}
                        alt="MediBook Dashboard"
                        fill
                ...
                The system supports dynamic slot generation, real-time polling,
                smart slot recommendations, and secure video consultations. It
                ensures smooth coordination between doctors and patients while
                giving administrators full control over system operations and
                analytics.
                </p>
                ...
                <ul className="mb-10 list-disc list-inside text-body-color text-lg">
                    <li>Doctor, Patient, and Admin role-based dashboards</li>
                    <li>Automated slot generation from doctor availability</li>
                    <li>AI-powered smart slot recommendation system</li>
                    <li>Real-time polling for booking and slot updates</li>
                    <li>Secure video consultations using WebRTC</li>
                    <li>System-wide analytics and admin override controls</li>
                </ul>
                <div className="relative z-10 mb-10 overflow-hidden rounded-md bg-primary bg-opacity-10 p-8 md:p-9 lg:p-8 xl:p-9">
                        <p className="text-center text-base font-medium italic text-body-color">
                        “MediBook simplifies healthcare scheduling by combining
                        intelligent automation, real-time communication, and secure
                ...
                <div className="flex flex-wrap items-center justify-between">
                    <div className="mb-5">
                        ...
                        <div className="flex flex-wrap">
                            ...
                            <TagButton text="AI Slot Scoring" />
                    ...
                    <div className="flex sm:justify-end">
                        <ShareProject
                            githubUrl="https://github.com/Shyam-Prasath/MediBook-Frontend"
                            liveUrl="https://medi-book-frontend-eight.vercel.app/login"
                        />
                    </div>
                    </div>
                </div>
            ...
            <aside className="w-full px-4 lg:w-4/12">
                ...
                <div className="flex flex-wrap px-8 py-6">
                    <TagButton text="Healthcare" />
                    <TagButton text="WebRTC" />
                    <TagButton text="AI Scheduling" />
                    <TagButton text="MongoDB" />
