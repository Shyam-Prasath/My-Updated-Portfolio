...
export const metadata: Metadata = {
    title: "TechStrike | Shyam Prasath",
};

const TechStrikePage = () => {
    return (
        ...
        <div className="container">
            ...
            <div className="w-full px-4 lg:w-8/12">
                ...
                <h1 className="mb-8 text-3xl font-bold leading-tight text-black dark:text-white sm:text-4xl">
                    TechStrike — AI & Blockchain Powered Talent Pool Management
                </h1>
                <div className="mb-10 flex flex-wrap items-center justify-between border-b border-body-color border-opacity-10 pb-4 dark:border-white/10">
                    ...
                    <p className="mb-5 flex items-center text-base font-medium text-body-color">
                        July 2025 • Full Stack + AI + Web3 Platform
                    </p>
                    </div>
                ...
                <p className="mb-10 text-lg leading-relaxed text-body-color">
                    TechStrike is an intelligent pool management platform that
                    combines AI-powered analytics and blockchain-based authentication
                    to connect consultants with opportunities. The system delivers
                    skill gap analysis, ATS scoring, training recommendations, and
                    role-based dashboards to optimize talent utilization.
                </p>

                <div className="mb-10 overflow-hidden rounded">
                    <div className="relative aspect-[97/44] w-full">
                    <Image
                        src={getImagePath("/images/tracebloom/Techstrike.png")}
                ...
                <p className="mb-8 text-lg leading-relaxed text-body-color">
                    The platform supports Admins and Consultants with separate
                    dashboards, real-time analytics, AI-powered resume parsing, job
                    matching, and attendance insights. Blockchain wallet
                    authentication ensures secure identity verification and
                ...
                <ul className="mb-10 list-disc list-inside text-body-color text-lg">
                    <li>Metamask wallet-based Web3 authentication</li>
                    <li>Role-based dashboards for Admins & Consultants</li>
                    <li>AI-powered resume parsing and ATS score calculation</li>
                    <li>Skill gap analysis with training recommendations</li>
                    <li>Job matching using AI-driven profile analysis</li>
                    <li>Attendance tracking with predictive insights</li>
                    <li>Advanced analytics and platform usage metrics</li>
                </ul>

                <div className="relative z-10 mb-10 overflow-hidden rounded-md bg-primary bg-opacity-10 p-8 md:p-9 lg:p-8 xl:p-9">
                        <p className="text-center text-base font-medium italic text-body-color">
                        “TechStrike transforms traditional talent pools into intelligent,
                        data-driven ecosystems powered by AI insights and blockchain
                        security.”
                        </p>
                ...
                <div className="flex flex-wrap items-center justify-between">
                    <div className="mb-5">
                        ...
                        <div className="flex flex-wrap">
                            ...
                            <TagButton text="Supabase" />
                            <TagButton text="Web3.js" />
                            <TagButton text="Ethereum" />
                            <TagButton text="AI / NLP" />
                        </div>
                    </div>
                    ...
                    <div className="flex sm:justify-end">
                        <ShareProject
                            githubUrl="https://github.com/Shyam-Prasath/Tech-Strike-Frontend"
                            liveUrl="https://tech-strike-frontend.vercel.app/"
                        />
                    </div>
                    </div>
                </div>
            ...
            <aside className="w-full px-4 lg:w-4/12">
                ...
                <ul className="p-8">
                    ...
                    <RelatedProject
                        title="Connect360"
                        image={getImagePath("/images/tracebloom/Connect360.png")}
                        slug="/Connect360"
                        date="July 2025"
                    />
                    </li>
                ...
                <div className="flex flex-wrap px-8 py-6">
                    <TagButton text="AI Resume Parsing" />
                    <TagButton text="Skill Gap Analysis" />
                    <TagButton text="ATS Scoring" />
                    <TagButton text="Metamask" />
                    <TagButton text="Supabase" />
                    <TagButton text="Predictive Analytics" />
                </div>
                </div>
            </aside>
            </div>
